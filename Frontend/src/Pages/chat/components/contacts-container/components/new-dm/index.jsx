        ...
        <Tooltip>
          <TooltipTrigger>
            ...
            <FiPlus
              ...
              className="text-neutral-500 font-light text-opacity-90 text-start hover:text-[#00DFC0] hover:rotate-90 cursor-pointer transition-all duration-300"
            />{" "}
          </TooltipTrigger>
        ...
        <DialogContent className="bg-[#181920] text-white w-[400px] h-[400px] flex flex-col">
          ...
          {searchedContacts.length <= 0 && (
            <div className="flex-1  md:flex mt-5 md:mt-0 flex-col justify-center items-center duration-1000 transition-all">
              ...
              />
              <div
                className="text-opacity-80 text-white flex flex-col 
                            gap-5 items-center mt-5 lg:text-2xl text-xl transition-all
                            duration-300 text-center"
              >
                <h3 className="poppins-medium">
                  Hi<span className="text-[#00DFC0]"> </span>
                  search new
                  <span className="text-[#00DFC0]"> Contact</span>
                </h3>
              </div>
            </div>
          )}
