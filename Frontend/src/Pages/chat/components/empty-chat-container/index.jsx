...
function EmptyChatContainer() {
  return (
    ...
    >
      ...
      gap-5 items-center mt-10 lg:text-4xl text-3xl transition-all
       duration-300 text-center'>

        <h3 className='poppins-medium'>Hi<span className='text-purple-500'> </span>
              Welcome to 
          <span className='text-[#00DFC0]'> Lumina Chat</span>
          </h3>
       </div>
